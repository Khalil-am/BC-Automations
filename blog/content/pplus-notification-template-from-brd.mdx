...
[Download P+ Notification Master Template (.xlsx)](/templates/Notifications_Template.xlsx) — Standard bilingual notification template with all 4 sheets: Level, Logs, Level WF, Log WF.
