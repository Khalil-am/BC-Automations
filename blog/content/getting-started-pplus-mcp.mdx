...
- `cd pplus-knowledge-mcp` — Enters the downloaded folder
...
```bash
git clone https://github.com/Khalil-am/PPlus-Agent.git
```

You should now have two folders on your Desktop:
- `pplus-knowledge-mcp` — The MCP server
- `PPlus-Agent` — The knowledge base
...
- Click on the `pplus-knowledge-mcp` folder
- Click the address bar at the top — it will show the full path (e.g., `C:\Users\YourName\Desktop\pplus-knowledge-mcp`)
- Do the same for the `PPlus-Agent` folder

**On macOS:**
- Open Finder and navigate to your Desktop
- Right-click the `pplus-knowledge-mcp` folder → **Get Info**
- The "Where" field shows the path. Your full path will be something like `/Users/YourName/Desktop/pplus-knowledge-mcp`
...
```json
{
  "mcpServers": {
    "pplus-knowledge": {
      "command": "node",
      "args": ["C:\\Users\\YourName\\Desktop\\pplus-knowledge-mcp\\dist\\index.js"],
      "env": {
        "PPLUS_KNOWLEDGE_PATH": "C:\\Users\\YourName\\Desktop\\PPlus-Agent\\knowledge"
      }
    }
  }
}
...
```json
{
  "mcpServers": {
    "pplus-knowledge": {
      "command": "node",
      "args": ["/Users/YourName/Desktop/pplus-knowledge-mcp/dist/index.js"],
      "env": {
        "PPLUS_KNOWLEDGE_PATH": "/Users/YourName/Desktop/PPlus-Agent/knowledge"
      }
    }
  }
}
...
1. Make sure you ran `npm run build` inside the `pplus-knowledge-mcp` folder
...
The path to the knowledge base is incorrect. Make sure the path in `.mcp.json` points to the `knowledge` folder **inside** the `PPlus-Agent` repository, not the repository root itself.

```text
Correct:   .../PPlus-Agent/knowledge
Incorrect: .../PPlus-Agent
```
...
| **Clone MCP server** | `git clone https://github.com/Khalil-am/pplus-knowledge-mcp.git` |
| **Build MCP server** | `cd pplus-knowledge-mcp && npm install && npm run build` |
| **Clone knowledge base** | `git clone https://github.com/Khalil-am/PPlus-Agent.git` |
...
- **[PPlus Knowledge Base on GitHub](https://github.com/Khalil-am/PPlus-Agent)** — Explore the 44+ knowledge chunks directly
- **[MCP Server on GitHub](https://github.com/Khalil-am/pplus-knowledge-mcp)** — View the server source code and contribute
